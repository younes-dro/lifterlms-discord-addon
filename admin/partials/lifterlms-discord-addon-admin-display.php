...
<h1><?php echo __( 'LifterLMS Discord Add On Settings', 'lifterlms-discord-add-on' ); ?></h1>
		...
		<ul class="skltbs-tab-group">
				...
				<li class="skltbs-tab-item">
					<button class="skltbs-tab" data-identity="lifterlms_application" ><?php echo __( 'Application Details', 'connect-lifterlms-discord' ); ?><span class="initialtab spinner"></span></button>
				</li>	
				<li class="skltbs-tab-item">
					<?php if ( ets_lifterlms_discord_check_saved_settings_status() ) : ?>
						<button class="skltbs-tab" data-identity="level-mapping" ><?php echo __( 'Role Mapping', 'connect-lifterlms-discord' ); ?></button>
						<?php endif; ?>
				</li>
				<li class="skltbs-tab-item">
				<button class="skltbs-tab" data-identity="advanced" ><?php echo __( 'Advanced', 'connect-lifterlms-discord' ); ?>	
				</button>
				</li>
				<li class="skltbs-tab-item">
				<button class="skltbs-tab" data-identity="appearance" ><?php echo __( 'Appearance', 'connect-lifterlms-discord' ); ?>	
				</button>
				</li>
				<li class="skltbs-tab-item">
